...
To regenerate the robots.txt evidence (`screenshot.jpg` and
`robots_txt_snapshot.txt`; needs Chrome installed):
...
actually written against. Both are regenerated by `capture_robots_evidence.py`.
